...
class function<ReturnType(Args...)> : public _function_base<ReturnType,Args...> { _memberfuncs };
// 函数指针
template <typename ReturnType, typename... Args>
class function<ReturnType(*)(Args...)> : _function_base<ReturnType(Args...)> {};

// std::function
template <typename _Func>
class function<std::function<_Func>> : function<_Func> {};

// 成员函数
#define FUNCTION(...) \
template <typename ReturnType, typename ClassType, typename... Args>\
class function<ReturnType(ClassType::*)(Args...) __VA_ARGS__> : function<ReturnType(Args...)>{};
...
class function : function<decltype(&Callable::operator())> {};
